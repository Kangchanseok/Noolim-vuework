...
<div id="hero-slides">
    ...
    <div id="slides-cont">
      ...
      <div id="slides">
        ...
        <div class="slide" style="background-image: url(../assets/Popular/Deoksugung.jpg)">
    ...
    <div class="carousel" id="slides-cont" @keydown="checkSlide($event)" tabindex="0">
        <slot></slot>
      <button @click="next" class="next-catch"></button>
      <button @click="prev" class ="prev-catch"></button>
    </div>
    </div>
