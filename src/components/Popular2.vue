<template>
  ...
  <slide >
    <div id="hero-slides">
      <!-- <div id="slides-cont"> -->
      <div id="slides">
        <div class="slide" @click="gogo" style="background-image: url(https://i.postimg.cc/k5w2g7kY/Gyeonghuigung.jpg)">
          ...
          <div class="body" >            
            ...
            <div class="headline">Photo by Bundo Kim</div>
...
<!-- 2 -->
  <slide>
    <div id="hero-slides">
      <!-- <div id="slides-cont"> -->
      <div id="slides">
    <div class="slide" @click="gogo" style="background-image: url(https://i.postimg.cc/635Gr8rN/Deoksugung.jpg)">
...
<!-- 3 -->
  ...
  <div>
    <div id="slides">
    <div class="slide" @click="gogo" style="background-image: url(https://i.postimg.cc/W15D2NRW/cait-ellis-Erld-XTq-Xv0-unsplash.jpg)">
...
<!-- 4 -->
  <slide>
    <div id="hero-slides">
      <!-- <div id="slides-cont"> -->
      <div id="slides">
    <div class="slide" @click="gogo" style="background-image: url(https://i.postimg.cc/fTwTkGf6/robson-hatsukami-morgan-ku9-Ftte6-Ymo-unsplash.jpg)">
...
// },
methods:{
  // click 이벤트시 router push와 함께 router push
  gogo(){
    this.$router.push({
